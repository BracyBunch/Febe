...
describe('Organization tests', function() {
  ...
  it('should be able to create an Organization', function(done) {
    models.Organization.create({'ein': '0', 'name': 'test_org', 'description': 'just a test', 'website_url': 'http://test.com', 'location': 'Testville'}, instances.rep).then(function(org) {
      ids_to_be_deleted.push(org.id);
      instances.org = org;

      expect(org).to.be.an('object');
      expect(org.name).to.be.a('string');
      expect(org.description).to.be.a('string');
      expect(org.description).to.eql('just a test');
      expect(org.website_url).to.be.a('string');
      done();
    }, done);
  });

  it('should be able to update an Organization', function(done) {
    models.Organization.update(instances.org.id, {'description': 'updated'}).then(function(org) {
      expect(org).to.be.an('object');
      expect(org.name).to.be.a('string');
      expect(org.description).to.be.a('string');
      expect(org.description).to.eql('updated');
      expect(org.website_url).to.be.a('string');
  ...
  it('should be able to update an Organization without an id parameter', function(done) {
    models.Organization.update({'id': instances.org.id, 'description': 'updated again'}).then(function(org) {
      expect(org).to.be.an('object');
      expect(org.name).to.be.a('string');
      expect(org.description).to.be.a('string');
      expect(org.description).to.eql('updated again');
      expect(org.website_url).to.be.a('string');
