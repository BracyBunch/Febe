...
xdescribe('Project Route Tests', function() {

    it('should return with status code 200 after POST to /project/add', function(done) {
      chai.request(app)
        .post('/project/add')
        .send({'Test': 'test'})
        .end(function(res){
    ...
    it('should return with status code 404 after GET to /project/add', function(done) {
      chai.request(app)
        .get('/project/add')
        .end(function(res){
